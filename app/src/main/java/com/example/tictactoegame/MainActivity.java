...
public class MainActivity extends AppCompatActivity {
    ...
    private void changePlayerTurn(int currentPlayerTurn){
        ...
        if(playerTurn == 1){
            playerOneLayout.setBackgroundResource(R.drawable.round_back_dark_blue_border);
            playerTwoLayout.setBackgroundResource(R.drawable.round_back_dark_blue);
        }
        else{
            playerTwoLayout.setBackgroundResource(R.drawable.round_back_dark_blue_border);
